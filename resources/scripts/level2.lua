Level = {
    ...
    ----------------------------------------------------
    assets = {
        { type = "texture", id = "tilemap-texture", file = "resources/tilemaps/desert.png" },
        {
            type = "texture",
            id = "tank-texture",
            file = "resources/textures/tank-panther-spritesheet.png",
        },
    ...
    ----------------------------------------------------
    tilemap = {
        map_file = "resources/tilemaps/desert.map",
